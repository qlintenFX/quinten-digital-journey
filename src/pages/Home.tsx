...
import ReactFullpage from 'fullpage.js/dist/fullpage.extensions.min';
...
const Home = () => {
  ...
  return (
    <ReactFullpage
      licenseKey={'GPL-3.0-or-later'}  // Open source license
      scrollingSpeed={1000}
      navigation={true}
      ...
      onLeave={(origin, destination, direction) => {
        // Optional: add custom logic when changing sections
      }}
