  ...
  return (
    <div className="snap-y snap-mandatory overflow-y-scroll h-screen">
      <div className="flex flex-col min-h-screen relative">
        ...
        {/* Hero Section */}
        <header className="container relative z-[2] snap-start" id="home">
        ...
        <section className="py-24 relative z-[2] before:content-[''] before:absolute before:inset-0 before:bg-gray-200/50 dark:before:bg-muted/30 before:-z-[1] snap-start" id="about">
        ...
        {/* Projects Section */}
        <section className="py-24 relative z-[2] snap-start" id="projects">
        ...
        <section className="py-24 relative z-[2] before:content-[''] before:absolute before:inset-0 before:bg-gray-200/50 dark:before:bg-muted/30 before:-z-[1] snap-start" id="youtube">
          <div className="container relative">
        ...
        {/* Socials Section */}
        <section className="py-24 relative z-[2] snap-start" id="contact">
          <div className="container">
            ...
            <div className="max-w-2xl mx-auto bg-card p-8 rounded-lg shadow-lg">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
                ...
                >
                  ...
                  <span className="text-sm font-medium group-hover:text-primary transition-colors">YouTube</span>
                </a>
        ...
        <footer className="py-12 bg-card">
          <div className="container">
            <div className="flex flex-col items-center justify-center text-center">
              <p className="text-muted-foreground mb-6">© 2023 Quinten's E-Portfolio. All rights reserved.</p>
              <p className="text-xs text-muted-foreground">Developed with React, Framer Motion, and Tailwind CSS.</p>
            </div>
          </div>
        </footer>
        ...
        <Dialog open={showCVDialog} onOpenChange={setShowCVDialog}>
          <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-4">
              <iframe src="/files/CV_Quinten.pdf" className="w-full h-[70vh]" />
            </div>
          </DialogContent>
        </Dialog>
        ...
        {selectedProject && (
          ...
          >
            <div className="p-4">
              <h3 className="text-xl font-semibold mb-4">{projects[selectedProject].title}</h3>
